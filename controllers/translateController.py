...
from modules.cache.translation_cache import get_cached_translation, cache_translation
import validators
import json
...
async def translate_text():
    ...
    cached_result = get_cached_translation(content_param, target_param)
    if cached_result:
        return Response(
    ...
    try:
        ...
        cache_translation(content_param, target_param, resp)
        return resp
    except Exception as e:
        error_response = jsonify(error=str(e))
        return error_response, 500
